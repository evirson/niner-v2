...
O botão de fechar do popup obrigatório de filtros usava `navigate('/')`, o que **empilha histórico**:
cada fechamento acrescentava uma entrada, e o botão "voltar" do navegador deixava de funcionar como
o usuário espera.
