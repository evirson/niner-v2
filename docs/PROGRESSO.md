...
Niner — busca por venda com detalhamento completo em quatro grids empilhadas: dados, produtos,
...
### 2026-07-31 — Ajustes de UI em Pesquisa de Vendas e Cancelamento de Venda (testes manuais)

Sessão de testes manuais (containers reconstruídos com o código de 2026-07-30, ainda não
commitado até este ponto). Dois ajustes pontuais pedidos ao vivo:
...
Ambos verificados ao vivo no navegador. Nenhuma mudança de backend; `tsc --noEmit` limpo.
...
2. **Pesquisa de Vendas (novo, `vendas.pesquisa`, docs/telas/pesquisa-vendas.md, qualquer
   ...
   pro schema real do Niner antes de implementar (seção própria "Adaptações em relação à
