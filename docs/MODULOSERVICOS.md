...
| **DS18** | De que estado a OS vai ao PDV | ✅ **Só CONCLUIDA** (2026-08-28) — o trabalho tem de estar pronto para virar venda. Quem cobra adiantado marca como concluída antes | §4.2 |
| **DS19** | Quando a peça reserva | ✅ **Ao ser lançada na OS** (2026-08-28), antes mesmo da aprovação — é o que protege de verdade: o cliente aprova amanhã e a peça ainda está lá | §4.3 |
| **DS20** | Faturamento parcial? | ⛔ **Não — a OS vira UMA venda e fecha** (2026-08-28). Quem levar menos, o operador tira o item no PDV. Saldo por item exigiria N vendas por OS | §4.2 |
