...
/**
 * PDF da DRE como captura visual, mesmo padrão dos demais relatórios.
 *
 * **Retrato**, diferente de Comissões/Contas a Receber (paisagem): a DRE tem poucas colunas e
 * muitas linhas — em paisagem a tabela fica esticada e as linhas espalhadas, e é o formato que o
 * contador espera receber.
 */
export async function gerarPdfCapturaDre(
