...
/** Rótulos amigáveis dos campos configuráveis (mesmos nomes usados em FuncionarioForm). */
...
/**
 * Configuração de tela do Funcionário (ADMIN, docs/telas/configuracao-tela.md): escolhe
 * quais campos aparecem no formulário e quais são obrigatórios. Nome não aparece aqui — é
 * estruturalmente obrigatório (NOT NULL no banco), não configurável.
 */
export default function ConfiguracaoTelaFuncionario() {
      ...
      <div className="lista-topo">
        <div className="topbar-tela">
          <div className="titulo-tela">
            ...
            <h1>Configurar tela de Funcionário</h1>
          </div>
          <div className="topbar-acoes">
            <AjudaDaTela chaveTela="comum.telaconfig.funcionario" />
            <BotaoFecharTela />
        ...
        <div className="card">
          <p className="muted" style={{ margin: 0 }}>
            Escolha quais campos aparecem no formulário de funcionário e quais são obrigatórios. Nome sempre
            aparece e é sempre obrigatório (não configurável).
          </p>
        </div>
      </div>
