...
import { IconeCliente, IconeEstoque, IconeFornecedor, IconeProduto, IconeRecebimentoCrediario } from '../../components/Icones'
// `IconeComponente` vive em lib/menu.ts (é o tipo usado pelo menu), não em components/Icones.
import type { IconeComponente } from '../../lib/menu'
