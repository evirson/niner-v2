...
const CONTEUDOS: Record<string, ConteudoAjuda> = {
  ...
  'canais.tela': {
    ...
    passos: [
      ...
      'Clique em "Conectar": você é levado ao Mercado Livre para entrar na SUA conta de vendedor e autorizar o Nainer. Terminando, o navegador volta sozinho para esta tela e a situação vira "Conectado".',
      'Depois de conectado, a coluna "Conta" mostra o código do seu vendedor no Mercado Livre — confira se é a conta certa.',
    ...
    errosComuns: [
      ...
      'A autorização precisa ser feita na conta de vendedor DA SUA LOJA no Mercado Livre — não na conta de quem instalou o sistema. Se conectar com a conta errada, use "Desconectar" e refaça.',
      'O pedido de conexão vale por 10 minutos. Se você demorar na tela do Mercado Livre, a volta avisa que não vale mais — é só clicar em "Conectar" de novo.',
      'Se a situação virar "Com erro", quase sempre é autorização revogada ou vencida no Mercado Livre: o botão "Reconectar" resolve.',
    ],
    urlVideo: null,
  },
  'expedicao.tela': {
