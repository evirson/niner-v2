...
const CONTEUDOS: Record<string, ConteudoAjuda> = {
  ...
  'crm.tela': {
    titulo: 'CRM',
    objetivo: 'Filtrar clientes por perfil e histórico de compras, e exportar a lista pra planilha Excel (campanhas de marketing/relacionamento).',
    passos: [
      ...
      'Marque em "Dados para Geração" quais colunas quer na planilha: Nome, Data de Nascimento, Gênero, E-mail, Celular, Primeira Compra, Última Compra, Nº de Compras, Valor Total Comprado, Ticket Médio e Nº de Dias sem Comprar.',
      'Clique em "Gerar Planilha Excel" — busca e baixa um arquivo .xlsx com uma linha por cliente encontrado na mesma ação (não existe um passo de "Buscar" separado); o toast de sucesso mostra quantos clientes entraram.',
    ],
    errosComuns: [
