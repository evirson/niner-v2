...
const CONTEUDOS: Record<string, ConteudoAjuda> = {
  ...
  'catalogo.produto.form': {
    ...
    passos: [
      ...
      'Ainda na seção "Fiscal": se esta mercadoria vem com ICMS-ST já retido pelo fornecedor (CSOSN 500) e você emite nota para CNPJ, informe a base e o valor do ST por unidade. Quando a compra entra por XML, o sistema usa o valor da própria nota do fornecedor e você não precisa preencher nada — esses campos são para o produto que nunca entrou por XML. Confirme os números com o seu contador.',
      'Salve.',
    ...
    errosComuns: [
      ...
      'A nota para CNPJ foi recusada dizendo que falta o ST retido: este produto sai com CSOSN 500 e a Receita exige o valor do ICMS-ST que o fornecedor já reteve. Se a compra entrou por XML, o sistema usa o valor de lá; se não, preencha "Base do ST por unidade" e "ICMS-ST por unidade" aqui, com o seu contador. A venda no balcão (NFC-e) não é afetada.',
      'Não vejo os campos de ICMS-ST: eles só aparecem para mercadoria — serviço não tem ICMS.',
    ],
    urlVideo: null,
  },
  ...
  'vendas.pesquisavendas.tela': {
    ...
    passos: [
      ...
      'Se a venda ficou SEM nota fiscal (o popup foi fechado antes de emitir), a reimpressão avisa e oferece o botão "Emitir Nota Fiscal" — a mesma pergunta de CPF do caixa. Venda que já tem nota não mostra esse botão: reimprimir nunca reemite documento fiscal.',
