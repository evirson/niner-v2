...
const CONTEUDOS: Record<string, ConteudoAjuda> = {
  ...
  'estoque.entrada.lista': {
    ...
    passos: [
      'Ao abrir a tela, um popup pede os filtros (fornecedor, empresa, nota fiscal, período) — clique em "Localizar" para ver a lista, ou "＋ Nova entrada" para pular direto para uma nova entrada.',
