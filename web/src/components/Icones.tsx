...
/** Ícone da tela de Moeda (forma de recebimento) — fixa a função da tela ao lado do título. */
export function IconeMoeda({ size = 28 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.6} stroke="currentColor" width={size} height={size} aria-hidden="true">
      <path
        strokeLinecap="round"
...
/** Ícone de cartão (débito/crédito) — usado no checklist de moedas do Tipo de Carteira. */
export function IconeFormaCartao({ size = 20 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.6} stroke="currentColor" width={size} height={size} aria-hidden="true">
      <path
        strokeLinecap="round"
...
/** Ícone de raio (Pix — recebimento instantâneo) — usado no checklist de moedas do Tipo de Carteira. */
export function IconeFormaPix({ size = 20 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.6} stroke="currentColor" width={size} height={size} aria-hidden="true">
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3.75 13.5 10.5 2.25 9 10.5h4.5L7.5 21.75 9 13.5h-5.25Z"
      />
    </svg>
  )
}
