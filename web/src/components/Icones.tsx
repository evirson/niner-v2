...
/** Cadeado — permissões de acesso (RBAC, 2026-08-27). */
export function IconeCadeado({ size = 28 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.6} stroke="currentColor" width={size} height={size} aria-hidden="true">
      <path
        strokeLinecap="round"
...
/** Chave de boca — Ordem de Serviço (S4): o trabalho que leva tempo, oficina ou banho e tosa. */
export function IconeOrdemServico({ size = 28 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" width={size} height={size} aria-hidden="true">
      <path
        strokeLinecap="round"
