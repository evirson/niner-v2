...
CREATE TABLE cfg_geral (
  ...
  cfg_consiste_valor_contas_pagar boolean NOT NULL DEFAULT true,  -- 2026-08-23 (Entrada de Produtos): true exige que a soma das duplicatas seja igual ao total dos produtos lançados (regra de 2026-08-14, que até aqui era fixa); false libera divergência (adiantamento, parte à vista, nota parcialmente financiada). DEFAULT true = comportamento de sempre
