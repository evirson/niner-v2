...
CREATE TABLE venda (
  ...
  id_funcionario integer             REFERENCES funcionario (id_funcionario),   -- vendedor
...
CREATE TABLE venda_devolucao (
  ...
  id_venda_credito   integer     REFERENCES venda (id_venda),
  id_venda_debito    integer     REFERENCES venda (id_venda),
