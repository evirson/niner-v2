...
CREATE TABLE produto_estoque (
  ...
  id_variacao        integer        NOT NULL REFERENCES produto_barra (id_variacao),
...
CREATE TABLE produto_movimento_mestre (
  ...
  id_devolucao     integer        REFERENCES venda_devolucao (id_devolucao),
  nota_fiscal      text
);
...
CREATE TABLE produto_movimento_detalhe (
  ...
  id_tenant            smallint       NOT NULL REFERENCES plataforma.tenant (id_tenant),
  id_movimento         integer        NOT NULL REFERENCES produto_movimento_mestre (id_movimento),
  id_empresa           integer        NOT NULL REFERENCES empresa (id_empresa),
...
CREATE TABLE produto_balanco (
  id_balanco    integer       GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  id_tenant     smallint      NOT NULL REFERENCES plataforma.tenant (id_tenant),
  id_empresa    integer       NOT NULL REFERENCES empresa (id_empresa),
  id_variacao   integer       NOT NULL REFERENCES produto_barra (id_variacao),
