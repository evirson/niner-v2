...
CREATE TABLE cfg_variante_linha (
  id_variante_linha bigint  GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  id_tenant     bigint      NOT NULL REFERENCES plataforma.tenant (id_tenant),
...
CREATE TABLE cfg_variante_coluna (
  id_variante_coluna bigint GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  id_tenant     bigint      NOT NULL REFERENCES plataforma.tenant (id_tenant),
...
CREATE TABLE produto_categoria (
  ...
  id_categoria bigint NOT NULL REFERENCES cfg_categoria_produto (id_categoria),
  id_tenant    bigint NOT NULL REFERENCES plataforma.tenant (id_tenant),
...
CREATE TABLE produto_barra (
  id_variacao        bigint      GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  id_tenant          bigint      NOT NULL REFERENCES plataforma.tenant (id_tenant),
  id_produto         bigint      NOT NULL REFERENCES produto (id_produto) ON DELETE CASCADE,
  id_variante_linha  bigint      REFERENCES cfg_variante_linha (id_variante_linha),
  id_variante_coluna bigint      REFERENCES cfg_variante_coluna (id_variante_coluna),
