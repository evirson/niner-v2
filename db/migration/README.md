...
| **V023** | `cfg_geral` (singleton por tenant; `cfg_usa_cor_grade` boolean default false desde 2026-08-08, substitui `cfg_usa_variante_linha`/`cfg_usa_variante_coluna`; sem `moeda_devolucao`) | ✅ |
