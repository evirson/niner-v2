 ...
 * contas_receber_detalhe}), lança em {@code caixa_detalhe} (abrindo o caixa do usuário
 * automaticamente se não houver um aberto) e agrupa tudo sob um {@code
 * contas_receber_lote} (cabeçalho que dá número real a {@code id_lote_recebimento}).
 *
