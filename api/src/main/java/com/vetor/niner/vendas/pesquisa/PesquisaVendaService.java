...
public class PesquisaVendaService {
    ...
    private List<ItemVendaPesquisaResponse> buscarItens(long idVenda) {
        return jdbc.sql("""
                        SELECT pb.sku AS codigo, p.descricao AS descricao_produto, vl.descricao AS variacao_linha,
                               vc.descricao AS variacao_coluna, pmd.qtd_produto, pmd.preco_venda, pmd.valor_desconto,
                ...
                .query((rs, n) -> new ItemVendaPesquisaResponse(
                        rs.getString("codigo"), rs.getString("descricao_produto"), rs.getString("variacao_linha"),
                        rs.getString("variacao_coluna"), rs.getBigDecimal("qtd_produto"), rs.getBigDecimal("preco_venda"),
